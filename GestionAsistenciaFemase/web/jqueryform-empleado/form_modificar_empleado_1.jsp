...
<!-- Email personal -->        
<div class="form-group email" data-fid="email_personal">
    <label class="control-label" for="email_personal">Email personal</label>
    <div class="input-group"><span class="input-group-addon left">
        <i class="glyphicon glyphicon-envelope"></i> </span>
    <input type="email" class="form-control" id="email_personal" 
        name="email_personal" value="<%=empleado.getEmailPersonal()%>"  placeholder="Ingrese E-mail personal" 
        data-rule-email="true" 
...
<select class="form-control" id="autorizaAusencia" name="autorizaAusencia"   
  ...
  <option  value="N">No</option>
    ...
    <%}else{%>
        <input type="hidden" id="claveMarcacion" name="claveMarcacion" value="<%=empleado.getClaveMarcacion()%>">
    <%}%>
    <!-- Oct 2022 -->
