/*! http://keith-wood.name/datepick.html
	...
	Written by Keith Wood (wood.keith{at}optusnet.com.au) Febrero 2010.
...
monthsOffset: function(date) { // Always start on the quarter
  ...
  alert('Selected ' + dates);
		...
		/** Default settings for the plugin.
			...
			@property {number} [firstDay=0] First day of the week, 0 = Domingo, 1 = Lunes, etc.
		...
		/** Localisations for the plugin.
			...
			@property {string[]} [monthNames=['Enero','Febrero',...,'Noviembre','Diciembre']]
						The long names of the months.
			@property {string[]} [monthNamesShort=['Ene','Feb',...,'Nov','Dic']]
						The short names of the months.
			@property {string[]} [dayNames=['Domingo','Lunes',...,'Viernes','Sabado']]
						The long names of the days of the week.
			@property {string[]} [dayNamesShort=['Dom','Lun','Mar','Mier','Jue','Vier','Sab']]
						The short names of the days of the week.
			@property {string[]} [dayNamesMin=['Do','Lu','Ma','We','Th','Fr','Sa']]
			...
			@property {number} [firstDay=0] The first day of the week, Dom = 0, Lun = 1, etc.
		...
		/** Format a date object into a string value.
			...
			@param {string[]} [settings.dayNames] Names of the days from Domingo.
			@param {string[]} [settings.dayNamesShort] Abbreviated names of the days from Domingo.
		...
		/** Parse a string value into a date object.
			...
			@param {string[]} [settings.dayNames] The names of the days from Domingo.
			@param {string[]} [settings.dayNamesShort] The abbreviated names of the days from Domingo.
...
var week = $.datepick.iso8601Week(new Date(2014, 12-1, 25)) */
		iso8601Week: function(year, month, day) {
			...
			checkDate.setMonth(0, 1); // Compare with Ene 1
