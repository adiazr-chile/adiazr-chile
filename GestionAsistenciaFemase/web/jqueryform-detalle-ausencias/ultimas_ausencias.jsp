    ...
    <div class="divTable">
            <div class="divTableBody">
              <div class="divTableRow">
                ...
                <div class="divTableHeading">&nbsp;Saldo vac.</div>
                <div class="divTableHeading">&nbsp;Hra inicio</div>
                <div class="divTableHeading">&nbsp;Hra fin</div>
                ...
                %>  
                        <div class="divTableRow">    
                          ...
                          <div class="divTableCell"><%=ultima.getHoraInicioFullAsStr()%></div>
                          <div class="divTableCell"><%=ultima.getHoraFinFullAsStr()%></div>
