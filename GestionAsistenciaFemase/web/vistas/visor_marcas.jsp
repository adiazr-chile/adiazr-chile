...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Marcas de asistencia<span class="light"></span></h1>
            <h2><%=theUser.getNombreCompleto()%>, <%=theUser.getUsername()%></h2>
        </div>
...
<div class="filtering">
    <form>
        ...
        <!--<input type="hidden" name="empresaId" id="empresaId" value="<%=theUser.getEmpresaId()%>">
        <input type="hidden" name="deptoId" id="deptoId" value="<%=theUser.getDeptoId()%>">
        <input type="hidden" name="cencoId" id="cencoId" value="<%=theUser.getCencoId()%>">-->
    </form>
</div>
