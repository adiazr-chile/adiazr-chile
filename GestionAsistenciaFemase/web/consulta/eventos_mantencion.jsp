...
<head>
    ...
    <title>Eventos de Sistema</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Registro de Eventos<span class="light"></span></h1>
...
<div class="filtering">
    <form>
        ...
        <a href="<%=request.getContextPath()%>/consulta/eventos_mantencion_hist.jsp">&nbsp;Ver Hist&oacute;rico</a>
    </form>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#EventosTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/EventosMantencionController?action=list'
            },
            fields: {
                username: {
                    title:'Usuario',
