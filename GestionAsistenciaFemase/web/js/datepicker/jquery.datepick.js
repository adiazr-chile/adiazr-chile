/* http://keith-wood.name/datepick.html
   ...
   Written by Keith Wood (kbwood{at}iinet.com.au) Febrero 2010.
...
function Datepicker() {
	this._defaults = {
		...
		firstDay: 0, // First day of the week, 0 = Domingo, 1 = Lunes, ...
...
$.extend(Datepicker.prototype, {
	...
	/* Format a date object into a string value.
	   ...
	   @param  settings  (object) attributes include:
	                     dayNamesShort    (string[]) abbreviated names of the days from Domingo (optional)
	                     dayNames         (string[]) names of the days from Domingo (optional)
