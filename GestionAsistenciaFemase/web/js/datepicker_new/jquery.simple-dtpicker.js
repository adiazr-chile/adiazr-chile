 ...
 (function($) {
	var lang = {
		...
		ro:{
			...
			months: ['Ian', 'Feb', 'Mar', 'Abr', 'Mai', 'Iun', 'Iul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'],
			sep: '.',
		...
		de: {
			days: ['So', 'Lu', 'Di', 'Mi', 'Do', 'Fr', 'Sa'],
			months: [ "Ene", "Feb", "März", "Abr", "Mai", "Juni", "Juli", "Ago", "Sept", "Okt", "Nov", "Dez" ],
			format: 'DD.MM.YYYY hh:mm'
		},
		sv: {
			days: ['Sö', 'Må', 'Ti', 'On', 'To', 'Fr', 'Lö'],
			months: [ "Ene", "Feb", "Mar", "Abr", "Maj", "Juni", "Juli", "Ago", "Sept", "Okt", "Nov", "Dic" ]
		},
		id: {
			days: ['Min','Sen','Sel', 'Rab', 'Kam', 'Jum', 'Sab'],
			months: [ "Ene", "Feb", "Mar", "Abr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des" ]
		},
		it: {
			days: ['Dom','Lun','Mar', 'Mer', 'Gio', 'Ven', 'Sab'],
			months: [ "Gen", "Feb", "Mar", "Abr", "Mag", "Giu", "Lug", "Ago", "Set", "Ott", "Nov", "Dic" ],
			format: 'DD/MM/YYYY hh:mm'
		},
		tr: {
			days: ['Pz', 'Pzt', 'Sal', 'Çar', 'Per', 'Cu', 'Cts'],
			months: [ "Ock", "Şub", "Mar", "Nis", "Mayo", "Haz", "Tem", "Agu", "Eyl", "Ekm", "Kas", "Arlk" ]
		},
		es: {
	...
	**/
	...
	var draw = function($picker, option, year, month, day, hour, min) {
		...
		for (var zz = 0; i < cellNum; i++) {
			...
			} else if (wday === 0) {/* Domingo */
				$td.addClass('wday_sun');
			} else if (wday == 6) {/* Sabado */
