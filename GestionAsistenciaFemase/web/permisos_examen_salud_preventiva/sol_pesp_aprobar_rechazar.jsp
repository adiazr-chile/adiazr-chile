...
<head>
    ...
    <title>Aprobar/Rechazar Solicitud Permisos Examen Salud Preventiva - Admin</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Aprobar/Rechazar Permisos Examen Salud Preventiva</h1>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#SolAdminTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/servlet/SolicitudPESPController?action=listDirector',
                updateAction:'<%=request.getContextPath()%>/servlet/SolicitudPESPController?action=apruebaRechaza'
            },
            fields: {
		id:{
                    title: 'ID',
