...
<%
    ...
    String saldoPostPESP = (String)request.getAttribute("saldoPostPESP");
    ArrayList<MensajeUsuarioVO> mensajes = (ArrayList<MensajeUsuarioVO>)request.getAttribute("mensajes");
    boolean ingresarPESP = (Boolean)request.getAttribute("ingresarPESP");
...
<html lang="en">
<head>
    <title>(FEMASE)Vista Previa - Solicitud de Permiso Examen Salud Preventiva</title>
...
<body>
 <form id="form1" name="form1" method="post" 
   ...
   <table align="center" summary="Vista Previa - Solicitud de Permiso Examen Salud Preventiva">
  <caption><span class="titulo_tabla">Vista Previa - Solicitud de Permiso Examen Salud Preventiva</span></caption>
  <thead>
  <%
      for (int i = 0; i < mensajes.size(); i++) {
		...
		System.out.println("[GestionFemaseWeb]permiso_examen_salud_preventiva/vista_previa.jsp]label=" + label + ",value= " + value);
            %>
            <tr>
    ...
    <tr>
        ...
        <input name="saldoPostVacaciones" type="hidden" id="saldoPostPESP" value="<%=saldoPostPESP%>" />
             ...
             <tr>
              ...
              <th width="50%" align="left" class="value_tabla" scope="col">
                <%if (ingresarPESP){%>
                    <input type="submit" value="Ingresar Solicitud de Permiso Examen Salud Preventiva" class="boton4"></th>
                <%}else{%>
