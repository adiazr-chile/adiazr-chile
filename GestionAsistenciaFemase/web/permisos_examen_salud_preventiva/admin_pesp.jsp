...
<head>
    ...
    <title>Administracion Permisos Examen Salud Preventiva</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Administraci&oacute;n Permisos Examen Salud Preventiva (ausencias)</h1>
            ...
            <select name="paramAusenciaId" id="paramAusenciaId">
                <%
                    ...
                    while(itera3.hasNext() ) {
                        ...
                        if (auxausencia.getId() == Constantes.ID_AUSENCIA_PERMISO_EXAMEN_SALUD_PREVENTIVA)
                        {%>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#PESPTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/DetalleAusenciaController?action=list&source=adm_pesp',
            ...
            fields: {
                ...
                idAusencia:{
                    ...
                    //},
                    options: { '44': 'Permiso Examen Salud Preventiva'},        
                    edit:true,
                    create:true,
                    list: false
                },
