...
<html lang="en">
<head>
    <title>(FEMASE)Solicitud de Permiso Examen Salud Preventiva - Ingresada</title>
...
<body>
 <form id="form1" name="form1" method="post" 
       action="<%=request.getContextPath()%>/servlet/xxxxcionesController" target="_self">

   <table align="center" summary="Vista Previa - Solicitud de Vacaciones">
  <caption><span class="titulo_tabla">Solicitud de Permiso Examen Salud Preventiva enviada</span></caption>
  <thead>
  <%
      for (int i = 0; i < mensajes.size(); i++) {
		...
		System.out.println("[GestionFemaseWeb]solicitud_pesp/vista_previa.jsp]label=" + label + ",value= " + value);
            %>
            <tr>
