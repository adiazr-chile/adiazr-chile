...
<head>
    ...
    <title>Solicitudes de Permiso Examen Salud Preventiva - Admin</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Solicitudes de Permisos Examen Salud Preventiva</h1>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#SolAdminTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/servlet/SolicitudPESPController?action=listAdmin'
            },
            fields: {
		id:{
                    title: 'ID',
