...
<head>
	<meta charset="UTF-8">
	<title>Planificacion Permisos Examen Salud Preventiva</title>
	<style>
		body {
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/permisos_examen_salud_preventiva/gantt_viewer/frappe_gantt_lib/frappe-gantt.css" />
	<script src="<%=request.getContextPath()%>/permisos_examen_salud_preventiva/gantt_viewer/frappe_gantt_lib/frappe-gantt.js"></script>
</head>
<body>
	<div class="container">
		<h2><%=labelFiltro%></h2>
