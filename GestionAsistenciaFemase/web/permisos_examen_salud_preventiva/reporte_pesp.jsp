...
<head>
    ...
    <title>Reporte de Permisos Examen Salud Preventiva</title>
...
<body>
        ...
        <div style="position:relative">
            <h4><br>
&nbsp;&nbsp;&nbsp;            Informe de Permisos Examen Salud Preventiva</h4><br>
        </div>
    ...
    <div class="filtering">
        <form id="demo-form" 
              action="<%=request.getContextPath()%>/servlet/PermisosExamenSaludPreventivaReport" 
              method="POST" 
