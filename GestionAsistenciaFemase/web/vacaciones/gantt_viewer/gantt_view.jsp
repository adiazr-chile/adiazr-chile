...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/vacaciones/gantt_viewer/frappe_gantt_lib/frappe-gantt.css" />
	<script src="<%=request.getContextPath()%>/vacaciones/gantt_viewer/frappe_gantt_lib/frappe-gantt.js"></script>
</head>
<body>
	<div class="container">
		<h2><%=labelFiltro%></h2>
