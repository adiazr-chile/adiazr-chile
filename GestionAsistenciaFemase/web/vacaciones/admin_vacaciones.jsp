...
<head>
    ...
    <title>Administracion Vacaciones</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
             ...
             $('#cencoId').change(function(event) {
                 ...
                 var sourceSelected = 'vacaciones_lista';
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Administraci&oacute;n vacaciones<span class="light"></span> </h1>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#VacacionesTableContainer').jtable({       
            ...
            defaultSorting: 'detalle_ausencia.fecha_inicio ASC', //Set default sorting
            actions: {
                listAction: '<%=request.getContextPath()%>/DetalleAusenciaController?action=list&source=adm_vacaciones',
            ...
            fields: {
                ...
                diasAcumuladosVacacionesAsignadas:{
                    title: 'Dias acum. vac asignadas',
                    width: '6%',
                    edit:false,
                    create:false,
                    key:false,
                ...
                diasEfectivosVacaciones:{
                    title: 'Dias efectivos',
                    width: '9%',
                    edit:false,
                    create:false,
                    key:false,
                ...
                saldoDiasVacacionesAsignadas:{
                    title: 'Saldo vac asignadas',
                    width: '6%',
                    edit:false,
                    create:false,
                    key:false,
