...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Aprobar/Rechazar Vacaciones</h1>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		rutEmpleado: {
                ...
                diasEfectivosVacacionesSolicitadas: {
                    ...
                    input: function (data) {
                        if (data.record) {
                            return '<input type="text" id="diasEfectivos" name="diasEfectivos" style="width:50px" value="' + data.record.diasEfectivosVacacionesSolicitadas + '" readonly />';
                        } 
                    } 
                },
                saldoVacaciones: {
                    title:'Saldo vacaciones',
                    width: '6%',
                    list: true,
                    create:false,
                    sorting: false,
                    ...
                    input: function (data) {
                        if (data.record) {
                            return '<input type="text" id="saldoVacaciones" name="saldoVacaciones" style="width:50px" value="' + data.record.saldoVacaciones + '" readonly />';
                        } 
                    }
                },
                diasEspeciales: {
