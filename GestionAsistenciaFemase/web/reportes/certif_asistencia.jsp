...
<head>
    ...
    <title>Reporte de Asistencia (CSV)</title>
                 ...
                 $.get('<%=request.getContextPath()%>/JsonListServlet', {
                        ...
                        for (i=0; i<response.length; i++) {
                            var auxNombre = '['+response[i].rut+'] '+response[i].nombres + 
                                ...
                                + ' (['+response[i].idTurno+']' + response[i].nombreTurno + ')';
...
<body>
    ...
    <div class="filtering">
        <form id="demo-form" 
              action="<%=request.getContextPath()%>/ReporteAsistenciaCert" 
              method="POST" 
            ...
            <div id="content4" align="left">    
                <div id="col1"><label>Centro de Costo</label></div>
                <div id="col2">    
            ...
            <!-- fin div turno -->
            <!-- inicio div turno rotativo -->
            <!--<div id="content5" align="left">
            	<div id="col1"><label>Turno (rotativo)</label></div>
                <div id="col2">            
                    <select id="turno_rotativo" name="turno_rotativo" style="width:350px;" required>
                        <option value="-1" selected>Cualquiera</option>
                        <%
                        Iterator<TurnoRotativoVO> iteraRotativos = turnosRotativos.iterator();
                        while(iteraRotativos.hasNext() ) {
                            TurnoRotativoVO auxobj = iteraRotativos.next();
                            String labelTurno = "[" + auxobj.getId() + "] " + auxobj.getNombre();
                            %>
                                <option value="<%=auxobj.getId()%>"><%=labelTurno%></option>
                        <%}%>
                        
                    </select>
                </div>
            </div> 
            <!-- fin div turno rotativo -->
