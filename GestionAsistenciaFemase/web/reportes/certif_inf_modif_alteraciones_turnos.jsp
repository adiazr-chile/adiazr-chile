...
<head>
    ...
    <title>Reporte de modificaciones y/o alteraciones de turnos</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#cencoId').change(function(event) {
                 ...
                 var sourceSelected = 'informe_jornada';
...
<body>
    ...
    <div class="filtering">
        <form id="demo-form" 
              action="<%=request.getContextPath()%>/ReporteModifAlterTurnos" 
              method="POST" 
