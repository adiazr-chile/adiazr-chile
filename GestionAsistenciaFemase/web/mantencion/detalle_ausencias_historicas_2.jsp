...
<head>
    ...
    <title>Ausencias Historicas</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Ausencias (con m&aacute;s de 6 meses de antig&uuml;edad)<span class="light"></span></h1>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#DetalleAusenciasTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/DetalleAusenciaHistController?action=list'
            },
            fields: {
                rutEmpleado: {
                    title:'Empleado',
                    options: function(data){
                        var auxempresa = $('#empresaId').val();
                        var auxdepto = $('#deptoId').val();
                        var auxcenco = $('#cencoId').val();
