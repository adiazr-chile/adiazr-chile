...
<%
    ...
    System.out.println("[GestionFemaseWeb]asignacion_cencos.jsp]-1-"
        + " strReload= " + strReload);
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <table width="44%" border="0" align="center">
          <tr>
            <td width="33%" class="h4">Turnos existentes</td>
            <td width="67%">&nbsp;</td>
            </tr>
          <tr>
          ...
          <tr>
            <td valign="top"><span class="h4">Turnos seleccionados</span></td>
