...
<%
    ...
    LinkedHashMap<Integer, TurnoRotativoVO> turnosDisponibles 
        = (LinkedHashMap<Integer, TurnoRotativoVO>)session.getAttribute("turnosrot_noasignados_cenco"); 
    
    LinkedHashMap<Integer, TurnoRotativoVO> turnosAsignados 
        = (LinkedHashMap<Integer, TurnoRotativoVO>)session.getAttribute("turnosrot_cenco"); 
...
<html lang="en">
<head>
  <title>(FEMASE)Asignacion turnos rotativos a centros de costo</title>
...
<body>
 <form name="asignacionccForm" action="<%=request.getContextPath()%>/servlet/AsignacionTurnosRotativosCencosServlet">
<div class="container">
            ...
            <td rowspan="3" valign="top">
              <select name="list1" size="8" 
                ...
                <%
                    int intValue = -1;
                    String strLabel = "";
                    Iterator<TurnoRotativoVO> it1 = turnosDisponibles.values().iterator();
                    while(it1.hasNext() ) {
                        TurnoRotativoVO auxTurno = it1.next();
                        intValue = auxTurno.getId();
                        strLabel = auxTurno.getNombre() 
                            + " (" + auxTurno.getHoraEntrada() + " a " + auxTurno.getHoraSalida() + ")";
          ...
          <tr>
            <td valign="top"><select name="list2" size="8" 
              ...
              <%
                    int intValue2 = -1;
                    String strLabel2 = "";    
                    Iterator<TurnoRotativoVO> it2 = turnosAsignados.values().iterator();
                    while(it2.hasNext() ) {
                        TurnoRotativoVO auxTurno2 = it2.next();
