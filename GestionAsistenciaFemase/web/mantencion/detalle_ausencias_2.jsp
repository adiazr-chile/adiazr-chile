...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Lista de Detalles Ausencias (&uacute;ltimos 6 meses)<span class="light"></span> </h1>
    ...
    $(document).ready(function () {
        ...
        $('#DetalleAusenciasTableContainer').jtable({       
            ...
            fields: {
                ...
                idAusencia:{
                    title: 'Motivo ausencia/justificación',
                    options: function(data){
                ...
                permiteHora: {
                    ...
                    width: '7%',
                    type: 'radiobutton',
                    options: { 'N': 'Ausencia por todo el día', 'S': 'Ausencia por hora'},
