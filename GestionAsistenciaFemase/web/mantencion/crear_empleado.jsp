    ...
    <form id="demo-form" action="<%=request.getContextPath()%>/EmpleadosController" 
        ...
        <div id="tabs">
            <ul>
              ...
              <li><a href="#fragment-2"><span>Informaci&oacute;n Personal-2</span></a></li>
			...
			<div id="columna2"><label for="rut">Num Ficha * :</label>
                        <input type="text" class="form-control" name="cod_interno" required maxlength="20"></div>
		</div>
                <div id="contenidos">
                    ...
                    <div id="columna2"><label for="apePaterno">Ap. Paterno * :</label>
                        <input type="text" class="form-control" name="apePaterno" required maxlength="50" id="apePaterno">
                    </div>
		</div>
            ...
            <div id="fragment-3">
                ...
                <div id="contenidos">   
                    <div id="columna2">&nbsp;
                        ...
                        <p>
                        Si: <input type="radio" name="contratoIndefinido" id="autorizaS" value="S" checked required>
                        No: <input type="radio" name="contratoIndefinido" id="autorizaN" value="N" >
                        </p>
                    </div>
                    <div id="columna1"><label for="fec_termino_contrato">Fecha termino contrato *:</label>
                      <input name="fechaTerminoContratoAsStr" type="text" required id="fechaTerminoContratoAsStr">
                    </div>
                </div>
                <div id="contenidos">   
                    <div id="columna1"><label for="art22">Art. 22 *:</label>
                      <p>
                        Si: <input type="radio" name="articulo22" id="articulo22" value="S" required>
                        No: <input type="radio" name="articulo22" id="articulo22" value="N" checked>
                        </p>
                    </div>
                    <div id="columna2">&nbsp;</div>
                </div>
                ...
                <div id="contenidos">
                    ...
                    <div id="columna2">
                        ...
                        No: <input type="radio" name="autorizaAusencia" id="autorizaN" value="N" checked>
                        </p> 
                    </div>
                </div>        
