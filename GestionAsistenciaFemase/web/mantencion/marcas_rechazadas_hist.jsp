...
<%
    ...
    System.out.println("[GestionFemaseWeb]marcas_rechazadas_hist.jsp]"
        + "startDate= "+startDate
        + ",endDate= "+endDate);
...
<head>
    ...
    <title>Marcas Rechazadas rechazadas</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
             ...
             //evento_2 para combo centro costo
             $('#cencoId').change(function(event) {
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#MarcasTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/MarcasRechazosHistController?action=list'
            },
            fields: {
                rutEmpleado: {
                    title: 'Rut',
