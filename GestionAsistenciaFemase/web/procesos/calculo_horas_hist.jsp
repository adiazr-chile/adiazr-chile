...
<head>
    ...
    <title>Calculo Asistencia (Historico)</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Calcular Asistencia (Historico)<span class="light"></span></h1>
            <h2>Empleados</h2>
        </div>
...
<div id="CalcHorasHistTableContainer"></div>
<script type="text/javascript">

    $(document).ready(function () {

        $('#CalcHorasHistTableContainer').jtable({       
            title: 'Empleados',
            ...
            actions: {
                ...
                listAction: function (postData) {
                    ...
                    return $.Deferred(function ($dfd) {
                        $.ajax({
                            url: '<%=request.getContextPath()%>/DetalleAsistenciaHistController?action=calcular',
                            type: 'POST',
                            dataType: 'json',
                            data: postData,
            ...
            fields: {
                ...
                ResultadosCalculo: {
                    ...
                    display: function (empleadoData) {
                        ...
                        $img.click(function () {
                            $('#CalcHorasHistTableContainer').jtable('openChildTable',
                                $img.closest('tr'),
                                {
                                    title: empleadoData.record.nombres + ' - Resultados',
                                    actions: {
                                        listAction: '<%=request.getContextPath()%>/DetalleAsistenciaHistController?'
                                            +'action=listResults'
        ...
        $('#LoadRecordsButton').click(function (e) {
            ...
            $('#CalcHorasHistTableContainer').jtable('load', {
...
<h3>&nbsp;</h3><div class="tabsContainer"><div id="tabs-webforms"></div>
   ...
   <script type="text/javascript">
        ...
        $(function() {
            ...
            $('#endDate').datepick({dateFormat: 'yyyy-mm-dd',maxDate: -180});
        });
