...
<%
    ...
    System.out.println("[GestionFemaseWeb]sol_pa_aprobar_rechazar.jsp]perfil de usuario= " + theUser.getIdPerfil());
...
<head>
    ...
    <title>Aprobar/Rechazar Solicitud Permisos Administrativos - Admin</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Aprobar/Rechazar Permisos Administrativos</h1>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#SolAdminTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/servlet/SolicitudPermisoAdministrativoController?action=listDirector',
                updateAction:'<%=request.getContextPath()%>/servlet/SolicitudPermisoAdministrativoController?action=apruebaRechaza'
            },
            fields: {
		id:{
                    title: 'ID',
		...
		runEmpleado: {
                    ...
                    input: function (data) {
                        if (data.record) {
                            return '<input type="text" id="runEmpleado" name="runEmpleado" style="width:100px" value="' + data.record.runEmpleado + '" readonly />';
                        } 
                    }
                },
                labelEmpleado: {
                ...
                diasSolicitados: {
                    ...
                    input: function (data) {
                        if (data.record) {
                            return '<input type="text" id="diasEfectivos" name="diasEfectivos" style="width:50px" value="' + data.record.diasSolicitados + '" readonly />';
                        } 
                    } 
                },
                jornada: {
		...
		fechaHoraApruebaRechaza: {
                ...
                Accion:{
                    ...
                    options: function(data){
                        ...
                        return '<%=request.getContextPath()%>/LoadItems?type=acciones_aprobar_rechazar&estadoSolicitud='+auxEstadoId+'&userSolicita='+userSolicita;
                    },
                    create:false,
                    list: false,
                    edit:true,
                ...
                notaObservacion: {
                    ...
                    input: function (data) {
                        if (data.record) {
                            return '<input type="text" id="notaObservacion" name="notaObservacion" style="width:200px" value="' + data.record.notaObservacion + '" />';
                        } 
                    }
                }    
            },
            ...
            recordsLoaded: function (event, data) {
                parent.frames.topFrame.location.href = '<%=request.getContextPath()%>/topFrame.jsp';
            },
