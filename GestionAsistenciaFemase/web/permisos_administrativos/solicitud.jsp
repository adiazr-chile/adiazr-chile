...
<head>
    ...
    <title>Solicitudes de Permisos administrativos propias</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Solicitudes de Permisos Administrativos (propias)</h1>
...
<!-- paramRutEmpleado-->
    <form>
        ...
        <label>Permisos administrativos, desde:
            <input name="startPA" type="text" id="startPA">
            hasta <input name="endPA" type="text" id="endPA">
        </label> 
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#SolicitudesTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/servlet/SolicitudPermisoAdministrativoController?action=listPropias&source=solicitante',
                //createAction:'<%=request.getContextPath()%>/servlet/SolicitudVacacionesController?action=create',
                <% if (!readOnly){%>
                    updateAction:'<%=request.getContextPath()%>/servlet/SolicitudPermisoAdministrativoController?action=updatePropias'
                <%}%>
            },
            fields: {
		id:{
