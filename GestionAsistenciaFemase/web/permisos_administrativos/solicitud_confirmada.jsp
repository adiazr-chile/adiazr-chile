...
<html lang="en">
<head>
    <title>(FEMASE)Solicitud de Permiso Administrativo - Ingresada</title>
...
<body>
 <form id="form1" name="form1" method="post" 
       action="<%=request.getContextPath()%>/servlet/SolicitudVacacionesController" target="_self">

   <table align="center" summary="Vista Previa - Solicitud de Vacaciones">
  <caption><span class="titulo_tabla">Solicitud de Permiso Administrativo enviada</span></caption>
  <thead>
  <%
