...
<head>
    ...
    <title>Solicitudes de Permiso Administrativo - Admin</title>
...
<body>
    <div class="site-container">
        <div class="main-header" style="position: relative">
            <h1>Solicitudes de Permisos Administrativos</h1>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#SolAdminTableContainer').jtable({       
            ...
            actions: {
                listAction: '<%=request.getContextPath()%>/servlet/SolicitudPermisoAdministrativoController?action=listAdmin'
            },
            fields: {
		id:{
                    title: 'ID',
