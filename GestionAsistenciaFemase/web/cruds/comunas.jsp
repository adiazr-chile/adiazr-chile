...
<%
    String mainTitle    = "Comunas";
    String fileTitle    = "comunas";
    String urlPattern   = "ComunasCRUD";
    List<ComunaVO> lista = (List<ComunaVO>)request.getAttribute("lista");
    if (lista == null) lista = new ArrayList<>();
    
    List<RegionVO> regiones = (List<RegionVO>)session.getAttribute("regiones");
    if (regiones == null) regiones = new ArrayList<>();
    
    //filtros de busqueda
    String filtroNombre = (String)request.getAttribute("filtroNombre");
    String filtroRegionId = (String)request.getAttribute("filtroRegionId");
    if (filtroNombre == null) filtroNombre = "";
    if (filtroRegionId == null) filtroRegionId = "1";
...
<html lang="es">
   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
            $(this).on('click', function(evt){
                ...
                document.getElementById("regionId").value = document.getElementById("filtroRegionId").value;
                ...
                var regionIdBuscar = document.searchForm.filtroRegionId;
                document.editNewForm.filtroRegionId.value = regionIdBuscar.value;
        ...
        $("#myTable").on('click','.btnSelect',function(){
             ...
             var regionId  = currentRow.find("td:eq(2)").text(); // get current row 3rd TD
             document.getElementById("action").value='update';
             setValuesToEdit(id, nombre, regionId);
        ...
        document.getElementById("filtroRegionId").value='<%=filtroRegionId%>';
    ...
    * 
    * */
    function setValuesToEdit(id, nombre, regionId){
        //campos de busqueda
        var nombreBuscar = document.searchForm.filtroNombre;
        var regionIdBuscar = document.searchForm.filtroRegionId;
	document.editNewForm.filtroNombre.value = nombreBuscar.value;
        ...
        var inputRegionId = document.getElementById("regionId");//listbox
        ...
        inputRegionId.value = regionId;
        
        inputID.readOnly = true;
        inputNombre.readOnly = false;
        inputRegionId.readOnly = false;
...
<form name="searchForm" id="searchForm" method="POST" action="<%=request.getContextPath()%>/<%=urlPattern%>?action=list" target="_self">
  <tr>
    ...
    <td width="25%">
        <select name="filtroRegionId" id="filtroRegionId">
            <%
            for (int i = 0; i < regiones.size(); i++) {
                RegionVO region = regiones.get(i);
                String label = region.getNombre();
            %>
            <option value="<%=region.getRegionId()%>"><%=label%></option>
            <%}%>
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<ComunaVO> iter = lista.iterator();
        ComunaVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
            ...
            <tr>
                ...
                <td><%= registro.getRegionId()%></td>
                <td><%= registro.getRegionNombre()%></td>
                <td>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer border-top-0 d-flex justify-content-center">
            ...
            <input type="hidden" name="filtroRegionId" id="filtroRegionId">
            <!-- Primary Key -->
