   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
            $(this).on('click', function(evt){
                ...
                document.getElementById("accesoRapido").value = 'N';
    ...
    <div class="modal-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col">
                Orden<input type="text"  name="orden" id="orden" placeholder="Ingrese">
            </div>
        </div>
        <!-- fin fila -->
        <!-- Inicio nueva fila -->    
        <div class="row">
            <div class="col">
                Icon Id<input type="text"  name="iconId" id="iconId" placeholder="Ingrese">
            </div>
            <div class="col">
                Acceso rapido
                <select name="accesoRapido" id="accesoRapido">
                		<option value="S" selected>Si</option>
                      <option value="N">No</option>
                </select>
            </div>
            <div class="col">
                Titulo<input type="text"  name="titulo" id="titulo" placeholder="Ingrese">
            </div>
            <div class="col">
                Sub Titulo<input type="text"  name="subTitulo" id="subTitulo" placeholder="Ingrese">
            </div>
        </div>
        <!-- fin fila -->
        <!-- Inicio nueva fila -->    
        <div class="row">
            <div class="col">
                Img<input type="text"  name="img" id="img" placeholder="Ingrese">
            </div>
        </div>    
</div>
