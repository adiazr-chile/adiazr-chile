...
<%
    String mainTitle    = "Cargos";
    String fileTitle    = "cargos";
    String urlPattern   = "CargosCRUD";
    List<CargoVO> list = (List<CargoVO>)request.getAttribute("lista");
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<CargoVO> iter = list.iterator();
        CargoVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
