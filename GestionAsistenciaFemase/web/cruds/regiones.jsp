...
<%
    String mainTitle    = "Regiones";
    String fileTitle    = "regiones";
    String urlPattern   = "RegionesCRUD";
    List<RegionVO> list = (List<RegionVO>)request.getAttribute("lista");
...
<html lang="es">
   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
        ...
        $("#myTable").on('click','.btnSelect',function(){
             ...
             setValuesToEdit(id, nombre, nombreCorto);
    ...
    * 
    * */
    function setValuesToEdit(id, nombre, nombreCorto){
        //campos de busqueda
        var nombreBuscar = document.searchForm.filtroNombre;
	document.editNewForm.filtroNombre.value = nombreBuscar.value;
        ...
        var inputNombreCorto = document.getElementById("nombreCorto");//listbox
        ...
        if (document.getElementById("action").value === 'delete'){
            ...
            inputNombreCorto.readOnly = true;
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<RegionVO> iter = list.iterator();
        RegionVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
    ...
    <div class="modal-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col">
                Nombre corto<input type="text"  name="nombreCorto" id="nombreCorto" placeholder="Ingrese texto">
            </div>
