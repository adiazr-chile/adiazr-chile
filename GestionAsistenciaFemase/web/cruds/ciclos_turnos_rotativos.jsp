...
<%
    String mainTitle    = "CiclosTurnosRotativos";
    String fileTitle    = "ciclos_turnos_rotativos";
    String urlPattern   = "CiclosTurnosRotativosCRUD";
    List<TurnoRotativoCicloVO> list = (List<TurnoRotativoCicloVO>)request.getAttribute("lista");
    if (list == null) list = new ArrayList<>();
  
    //filtros de busqueda
    String filtroNombre = (String)request.getAttribute("filtroNombre");
    if (filtroNombre == null) filtroNombre = "";
    String empresaId = (String)request.getAttribute("empresaId");
...
<html lang="es">
   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
            $(this).on('click', function(evt){
                ...
                document.getElementById("numDias").value = '7';
                ...
                document.getElementById("etiqueta").readOnly = false;
                document.getElementById("numDias").readOnly = false;
        ...
        $("#myTable").on('click','.btnSelect',function(){
            ...
            var empresaId = '<%=empresaId%>'; // get current row 2nd TD
            var etiqueta  = currentRow.find("td:eq(1)").text(); // get current row 3rd TD
            var numDias  = currentRow.find("td:eq(2)").text(); // get current row 3rd TD
            document.getElementById("action").value='update';
            setValuesToEdit(id, empresaId,etiqueta, numDias);
    ...
    * 
    * */
    function setValuesToEdit(id, empresaId,etiqueta, numDias){
        //campos de busqueda
        var nombreBuscar = document.searchForm.filtroNombre;
	document.editNewForm.filtroNombre.value = nombreBuscar.value;
        ...
        var inputEmpresaId = document.getElementById("empresaId");
        var inputEtiqueta = document.getElementById("etiqueta");
        var inputNumDias = document.getElementById("numDias");
        ...
        inputNumDias.value = numDias;
        
        inputID.readOnly = true;
        inputEmpresaId.readOnly = false;
        inputEtiqueta.readOnly = false;
        inputNumDias.readOnly = false;
        ...
        if (document.getElementById("action").value === 'delete'){
            ...
            inputEmpresaId.readOnly = true;
            inputEtiqueta.readOnly = true;
            inputNumDias.readOnly = true;
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<TurnoRotativoCicloVO> iter = list.iterator();
        TurnoRotativoCicloVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
            
            <tr>
                <td><%= registro.getCorrelativo()%></td>
                <td><%= registro.getEtiqueta()%></td>
                <td><%= registro.getNumDias()%></td>
                <td><%= registro.getFechaCreacion()%></td>
                <td><%= registro.getFechaModificacion()%></td>
                <td>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                Correlativo<input type="text"  name="id" id="id">
            </div>
            <div class="col">
                Etiqueta<input type="text"  name="etiqueta" id="etiqueta" placeholder="Ingrese etiqueta">
