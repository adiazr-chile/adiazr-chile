...
<%
    String mainTitle    = "Perfiles de Usuario";
    String fileTitle    = "perfiles_usuario";
    String urlPattern   = "PerfilesUsuarioCRUD";
    List<PerfilUsuarioVO> list = (List<PerfilUsuarioVO>)request.getAttribute("lista");
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<PerfilUsuarioVO> iter = list.iterator();
        PerfilUsuarioVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
