...
<%@page import="cl.femase.gestionweb.vo.CodigoErrorRechazoVO"%>
...
<%
    String mainTitle    = "Codigos Error Rechazos";
    String fileTitle    = "codErrorRechazos";
    String urlPattern   = "CodigosErrorRechazosCRUD";
    List<CodigoErrorRechazoVO> list = (List<CodigoErrorRechazoVO>)request.getAttribute("lista");
    if (list == null) list = new ArrayList<>();
   
    //filtros de busqueda
    String filtroDescripcion = (String)request.getAttribute("filtroDescripcion");
    if (filtroDescripcion == null) filtroDescripcion = "";
...
<html lang="es">
   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
            $(this).on('click', function(evt){
                ...
                var nombreBuscar = document.searchForm.filtroDescripcion;
                document.editNewForm.filtroDescripcion.value = nombreBuscar.value;
        ...
        $("#myTable").on('click','.btnSelect',function(){
             ...
             var descripcion  = currentRow.find("td:eq(1)").text(); // get current row 3rd TD
             document.getElementById("action").value='update';
             setValuesToEdit(id, descripcion);
        ...
        document.getElementById("filtroDescripcion").value='<%=filtroDescripcion%>';
    ...
    * 
    * */
    function setValuesToEdit(id, descripcion){
        //campos de busqueda
        var nombreBuscar = document.searchForm.filtroDescripcion;
	document.editNewForm.filtroDescripcion.value = nombreBuscar.value;
        ...
        var inputDescripcion = document.getElementById("descripcion");//listbox
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<CodigoErrorRechazoVO> iter = list.iterator();
        CodigoErrorRechazoVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                Codigo<input type="text"  name="id" id="id">
            </div>
            <div class="col">
                Descripcion<input type="text"  name="descripcion" id="descripcion" placeholder="Ingrese descripcion">
            </div>
      ...
      <div class="modal-footer border-top-0 d-flex justify-content-center">
            ...
            <input type="hidden" name="filtroDescripcion" id="filtroDescripcion">
