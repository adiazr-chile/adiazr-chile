...
<%
    String mainTitle    = "Tipos Dispositivos";
    String fileTitle    = "tiposDispositivos";
    String urlPattern   = "TiposDispositivosCRUD";
    List<TipoDispositivoVO> list = (List<TipoDispositivoVO>)request.getAttribute("lista");
...
<html lang="es">
   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
        ...
        $("#myTable").on('click','.btnSelect',function(){
             ...
             var descripcion  = currentRow.find("td:eq(2)").text(); // get current row 3rd TD
             document.getElementById("action").value='update';
             setValuesToEdit(id, nombre, descripcion);
    ...
    * 
    * */
    function setValuesToEdit(id, nombre, descripcion){
        //campos de busqueda
        var nombreBuscar = document.searchForm.filtroNombre;
	document.editNewForm.filtroNombre.value = nombreBuscar.value;
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<TipoDispositivoVO> iter = list.iterator();
        TipoDispositivoVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
    ...
    <div class="modal-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col">
                Label<input type="text"  name="descripcion" id="descripcion" placeholder="Ingrese descripcion">
            </div>
