...
<%
    String mainTitle    = "Proveedores Correo";
    String fileTitle    = "proveedoresCorreo";
    String urlPattern   = "ProveedoresCorreoCRUD";
    List<ProveedorCorreoVO> list = (List<ProveedorCorreoVO>)request.getAttribute("lista");
...
<html lang="es">
   ...
   <script type="text/javascript" language="javascript" src="https://cdn.datatables.net/buttons/1.5.2/js/buttons.colVis.min.js"></script>
	...
	$('.dt-add').each(function () {
        ...
        $("#myTable").on('click','.btnSelect',function(){
             ...
             var dominio  = currentRow.find("td:eq(2)").text(); // get current row 3rd TD
             document.getElementById("action").value='update';
             setValuesToEdit(id, nombre, dominio);
    ...
    * 
    * */
    function setValuesToEdit(id, nombre, dominio){
        //campos de busqueda
        var nombreBuscar = document.searchForm.filtroNombre;
	document.editNewForm.filtroNombre.value = nombreBuscar.value;
        ...
        var inputDominio = document.getElementById("dominio");//listbox
  ...
  <div class="row">
    ...
    <div class="col-12" > 
      ...
      <table id="myTable" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <%
        Iterator<ProveedorCorreoVO> iter = list.iterator();
        ProveedorCorreoVO registro = null;
        while (iter.hasNext()) {
            registro = iter.next();
        %>
            ...
            <tr>
                ...
                <td><%= registro.getDomain()%></td>
                <td><%= registro.getCreateDate()%></td>
                <td><%= registro.getUpdateDate()%></td>
                <td>
    ...
    <div class="modal-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col">
                Dominio<input type="text"  name="dominio" id="dominio" placeholder="Ingrese dominio">
            </div>
