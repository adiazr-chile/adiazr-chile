...
function CalendarControl() {
    ...
    function calendarDrawTable() {
        ...
        table = table + "<tr class='cl_header'><th colspan='3' style='padding: 3px;'><a href='javascript:;' onclick='javascript:clearCalendarControl();'>Limpiar</a> | <a href='javascript:;' onclick='javascript:hideCalendarControl();'>Cerrar</a></td></tr>";
        table = table + "</table>";
        return table;
    }
    this.show = show;
