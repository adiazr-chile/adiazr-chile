...
public class ReseteoDiasAdministrativosFMCJob implements Job {
    ...
    public void execute(JobExecutionContext arg0) throws JobExecutionException {
        System.out.println("\n[GestionFemase."
            + "ReseteoDiasAdministrativosFMCJob]"
        ...
        if (deleteRows){
            ...
            System.out.println("[GestionFemase."
                + "ReseteoDiasAdministrativosFMCJob]Finaliza reseteo de dias administrativos (en la tabla 'permiso_administrativo')."
                + "Empresa:" + empresaId 
                + ", anio= " + CURRENT_YEAR    
                + ", id_proceso= " + procesoId
                + ", resultado: " + result
