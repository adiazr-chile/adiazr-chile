...
//        
        try {
            ...
            System.err.println("[GestionFemase."
                + "TraspasoHistoricosFemaseJob]Error:"+ex.toString());
    ...
    private int insertMarcasHistoricas(String _empresaId){
        ...
        try{
            String sql = "insert into marca_historica ("
                + "cod_dispositivo,empresa_cod,rut_empleado,"
                + "fecha_hora,cod_tipo_marca,"
                + "fecha_hora_actualizacion,id,"
                + "hashcode,modificada,comentario, "
                + "fecha_hora_traspaso, correlativo) "
                + "select cod_dispositivo,empresa_cod,rut_empleado,"
                    + "	fecha_hora,cod_tipo_marca,"
                    + "fecha_hora_actualizacion,"
                    + "id,hashcode,modificada,"
                    + "comentario, current_timestamp, correlativo "
                    + "from marca "
            ...
            rowsAffected = -1;
            System.err.println("[GestionFemase."
                + "TraspasoHistoricosFemaseJob.insertMarcasHistoricas]Error:"+sqle.toString());
        }
    ...
    private int insertMarcasRechazosHistoricas(String _empresaId){
        ...
        try{
            ...
            rowsAffected = -1;
            System.err.println("[GestionFemase."
                + "TraspasoHistoricosFemaseJob.insertMarcasRechazosHistoricas]Error:"+sqle.toString());
        }
    ...
    private int insertAusenciasHistoricas(String _empresaId){
        ...
        try{
            String sql = "insert into detalle_ausencia_historica ("
                ...
                + "fecha_hora_traspaso, empresa_id) "
                + " select "
                + " rut_empleado, "
                + " fecha_ingreso,ausencia_id,"
                + " fecha_inicio,fecha_fin,rut_autoriza_ausencia,"
                + " ausencia_autorizada,fecha_actualizacion,hora_inicio,"
                + " hora_fin,allow_hour,correlativo,current_timestamp,'" + _empresaId + "' "
            ...
            insertedRows =-1;
            System.err.println("[GestionFemase."
                + "TraspasoHistoricosFemaseJob.insertAusenciasHistoricas]Error:"+sqle.toString());
        }
    ...
    private int insertDetalleAsistenciaHistoricos(String _empresaId){
        ...
        try{
            ...
            insertedRows =-1;
            System.err.println("[GestionFemase."
                + "TraspasoHistoricosFemaseJob.insertDetalleAsistenciaHistoricos]Error:"+sqle.toString());
        }
