...
@WebServlet(name = "GanttPermisosAdministrativos", urlPatterns = {"/servlet/GanttPermisosAdministrativos"})
public class GanttPermisosAdministrativos extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final long serialVersionUID = 196L;
    
    public GanttPermisosAdministrativos() {
...
//                VacacionesBp vacacionesBp = new VacacionesBp(appProperties);
                ...
                try{
                    ...
                    while(it.hasNext()){
                        ...
                        Iterator<DetalleAusenciaVO> itPA = listaPA.iterator();
                        while(itPA.hasNext()){
                            DetalleAusenciaVO ausencia = itPA.next();
...
//                            }
                    ...
                    try {
                        ...
                        System.err.println("[servlet.GanttPermisosAdministrativos]error al parsear fecha: " + ex.toString());
                    }
...
//                    response.getWriter().write(arbolToJson);
                    ...
                    request.getRequestDispatcher("/permisos_administrativos/gantt_viewer/gantt_view.jsp").forward(request, response);
