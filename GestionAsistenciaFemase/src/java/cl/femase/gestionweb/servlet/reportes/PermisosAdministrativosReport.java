 ...
 * @author Alexander
 */
@WebServlet(name = "PermisosAdministrativosReport", urlPatterns = {"/servlet/PermisosAdministrativosReport"})
public class PermisosAdministrativosReport extends BaseServlet {
    ...
    protected FileGeneratedVO processRequestRut(HttpServletRequest request, 
        ...
        if (tipoParam.compareTo("1") == 0){
            ...
            if (reportParameters != null){
                ...
                try {
                    dbConn = dbLocator.getConnection(m_dbpoolName,"[PermisosAdministrativosReport.doPost]");
                } catch (DatabaseException ex) {
                    System.err.println("[servlet.reportes."
                        + "PermisosAdministrativosReport."
...
//        
    ...
    private void showFileToDownload(FileGeneratedVO _fileGenerated,
        ...
        try{
            ...
            System.err.println("[PermisosAdministrativosReport.showFileToDownload]Error al generar pdf: "+e.toString());
            e.printStackTrace();
        }
