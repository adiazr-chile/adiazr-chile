 ...
 * @author Alexander
 */
@WebServlet(name = "PermisosExamenSaludPreventivaReport", urlPatterns = {"/servlet/PermisosExamenSaludPreventivaReport"})
public class PermisosExamenSaludPreventivaReport extends BaseServlet {
    ...
    protected FileGeneratedVO processRequestRut(HttpServletRequest request, 
        ...
        try {
            ...
            System.err.println("[servlet.reportes."
                + "PermisosExamenSaludPreventivaReport.processRequestRut]"
                + "Error: "+ex.toString());
        }
        System.out.println(WEB_NAME+"[PermisosExamenSaludPreventivaReport.processRequestRut]"
            + "Abrir conexion a la BD. Datasource: " + m_dbpoolName);
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.processRequestRut]tipoParam: "+tipoParam);
        if (tipoParam.compareTo("1") == 0){
            if (_rutParam==null) return null;
            String jasperfile= "permisos_examen_salud_preventiva.jasper";
            System.out.println(WEB_NAME+"[servlet.reportes."
                + "PermisosExamenSaludPreventivaReport]"
                + "tipo: " + tipoParam
                + ", formato: " + formato);
            fileName = "pesp_" + _rutParam + "." + formato;
            ...
            if (reportParameters != null){
                ...
                try {
                    dbConn = dbLocator.getConnection(m_dbpoolName,"[PermisosExamenSaludPreventivaReport.doPost]");
                } catch (DatabaseException ex) {
                    System.err.println("[servlet.reportes."
                        + "PermisosExamenSaludPreventivaReport."
    ...
    */
    private HashMap getParameters(String _username, 
        ...
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.getParameters]Inicio...");
        ...
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.getParameters]. "
        ...
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.getParameters]"
            + "Obtener Info resumen Permisos Examen salud preventiva (tabla 'permiso_examen_salud_preventiva')");
        double diasDisponibles  = 0;
        double diasUtilizados   = 0;
        PermisosExamenSaludPreventivaDAO pespDao = 
            new PermisosExamenSaludPreventivaDAO(appProperties);
        List<PermisoExamenSaludPreventivaVO> infoPESP = 
            pespDao.getResumenPermisosExamenSaludPreventiva(empresaParam, 
                _rutEmpleado, anioParam, -1, -1, -1, "pesp.run_empleado");
        PermisoExamenSaludPreventivaVO saldoPESP = new PermisoExamenSaludPreventivaVO();
        if (!infoPESP.isEmpty()){
            saldoPESP = infoPESP.get(0);
        ...
        double MAXIMO_ANUAL_DIAS_PESP = parametrosSistema.get(Constantes.ID_PARAMETRO_MAXIMO_ANUAL_DIAS_PESP);
        if (MAXIMO_ANUAL_DIAS_PESP == 0) MAXIMO_ANUAL_DIAS_PESP = 1;
        
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.getParameters]Datos en resumen de permisos examen salud preventiva."
            + " Num maximo anual de dias PESP: " + MAXIMO_ANUAL_DIAS_PESP
        ...
        parameters.put("dias_acumulados", MAXIMO_ANUAL_DIAS_PESP);
        ...
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.getParameters]Fin.");
    ...
    */
    private List<EmpleadoVO> getEmpleados(String _empresaId,
        ...
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.getEmpleados]"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        HttpSession session = request.getSession(true);
        System.out.println(WEB_NAME+"[PermisosExamenSaludPreventivaReport.doGet]entrando...");
...
//        
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(WEB_NAME+"[PermisosExamenSaludPreventivaReport.doPost]"
            + "empresaId: " + empresaId
            + ", deptoId: " + deptoId
            ...
            for (EmpleadoVO empleado : listaEmpleados) {
                ...
                //if (!ausencias.isEmpty()){
                    ...
                    if (archivoGenerado != null){
                        System.out.println(WEB_NAME+"[PermisosExamenSaludPreventivaReport.doPost]Add "
    ...
    private void showFileToDownload(FileGeneratedVO _fileGenerated,
        ...
        int length   = 0;
        //pdf
        System.out.println(WEB_NAME+"[PermisosExamenSaludPreventivaReport.showFileToDownload]Generar PDF."
        ...
        try{
            ...
            System.err.println("[PermisosExamenSaludPreventivaReport.showFileToDownload]Error al generar pdf: "+e.toString());
            e.printStackTrace();
        }
    ...
    public FileGeneratedVO mergePdfFiles(LinkedHashMap<String, String> _archivos, 
        ...
        System.out.println(WEB_NAME+"[servlet.reportes."
            + "PermisosExamenSaludPreventivaReport.mergePdfFiles]"
        ...
        try
        {
            ...
            for( String key : _archivos.keySet() ){
                ...
                System.out.println(WEB_NAME+"[servlet.reportes."
                    + "PermisosExamenSaludPreventivaReport.mergePdfFiles]itera archivo " + pathFile);
            ...
            for( String key : _archivos.keySet() ){
                ...
                System.out.println(WEB_NAME+"[servlet.reportes."
                    + "PermisosExamenSaludPreventivaReport.mergePdfFiles]Eliminando archivo " + pathFile2);
                itFile2.delete();
            }
