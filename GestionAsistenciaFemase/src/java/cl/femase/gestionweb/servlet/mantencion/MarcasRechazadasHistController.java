...
public class MarcasRechazadasHistController extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final long serialVersionUID = 996L;
    
    public MarcasRechazadasHistController() {
            ...
            if (action.compareTo("list") == 0){
                ...
                try{
                    ...
                    if (cencoId != null && cencoId.compareTo("-1")!=0 
                        ...
                        listaObjetos = auxnegocio.getMarcasRechazadasHist(empresaId,
                        ...
                        objectsCount = auxnegocio.getMarcasRechazadasHistCount(empresaId,
                            request.getParameter("rutEmpleado"),
                            request.getParameter("dispositivo"),
                            request.getParameter("startDate"), 
                            request.getParameter("endDate"));
