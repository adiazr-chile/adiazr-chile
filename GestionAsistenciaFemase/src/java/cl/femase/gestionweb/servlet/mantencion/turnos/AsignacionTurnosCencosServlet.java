...
public class AsignacionTurnosCencosServlet extends BaseServlet {
    ...
    public AsignacionTurnosCencosServlet() {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(request.getParameter("action") != null){
            ...
            if (action.compareTo("list_turnos") == 0) {
                ...
                try{
                    LinkedHashMap<Integer, TurnoVO> listaTurnosCenco 
                        = turnosBp.getTurnosAsignadosByCenco(empresaId, 
                            deptoId,
                            Integer.parseInt(cencoId));
                    
                    LinkedHashMap<Integer, TurnoVO> listaTurnosNoAsignadosCenco 
                        = turnosBp.getTurnosNoAsignadosByCenco(empresaId, 
                            deptoId,
                            Integer.parseInt(cencoId));
                    
                    session.removeAttribute("turnos_noasignados_cenco");
                    session.removeAttribute("turnos_cenco");
                    ...
                    session.setAttribute("turnos_noasignados_cenco", listaTurnosNoAsignadosCenco);
                    session.setAttribute("turnos_cenco", listaTurnosCenco);
                    
                    //Return Json in the format required by jTable plugin
                    request.getRequestDispatcher("/mantencion/turnos/asignacion_cencos.jsp").forward(request, response);
                    ...
                    request.getRequestDispatcher("/mantencion/turnos/asignacion_cencos_resultado.jsp").forward(request, response);
        ...
        try {
            ...
            if (asignaciones != null && asignaciones.size() > 0){
                ...
                while( iterador.hasNext() ) {
                    ...
                    TurnoVO auxTurno = turnosBp.getTurno(asignacion.getTurnoId());
