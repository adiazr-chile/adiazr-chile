...
public class Cargos extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final String CRUD_TABLE_NAME     = "Cargos";
    private static final String CRUD_SERVLET_NAME   = "[Cargos.servlet]";
    private static final String FORWARD_PAGE        = "cruds/cargos.jsp";
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        CargoBp claseBp = new CargoBp(appProperties);
    ...
    */
    private void forwardToCRUDPage(HttpServletRequest _request, 
        ...
        try {
            List<CargoVO> listaObjetos = new ArrayList<>();
            System.out.println(WEB_NAME + CRUD_SERVLET_NAME + "CRUD - " + CRUD_TABLE_NAME
                + ". filtroNombre: " + _filtroBusqueda.getNombre()
                + ". filtroEstado: " + _filtroBusqueda.getEstado());
            listaObjetos = _auxnegocio.getCargos(_filtroBusqueda.getNombre(),
                _filtroBusqueda.getEstado(), 0, 0, "cargo_nombre");
