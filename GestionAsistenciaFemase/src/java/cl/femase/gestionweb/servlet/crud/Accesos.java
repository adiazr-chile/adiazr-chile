...
public class Accesos extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final String CRUD_TABLE_NAME     = "Accesos";
    private static final String CRUD_SERVLET_NAME   = "[Accesos.servlet]";
    private static final String FORWARD_PAGE        = "cruds/accesos.jsp";
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        AccesoBp claseBp = new AccesoBp(appProperties);
        ...
        if(request.getParameter("action") != null){
            ...
            AccesoVO registro = new AccesoVO();
            ...
            if(request.getParameter("label")!=null){
                registro.setLabel(request.getParameter("label"));
            }
            if(request.getParameter("url")!=null){
                registro.setUrl(request.getParameter("url"));
            }
    ...
    */
    private void forwardToCRUDPage(HttpServletRequest _request, 
        ...
        AccesoBp _auxnegocio,
        FiltroBusquedaCRUDVO _filtroBusqueda){
    
        try {
            List<AccesoVO> listaObjetos = new ArrayList<>();
            System.out.println(WEB_NAME + CRUD_SERVLET_NAME + "CRUD - " + CRUD_TABLE_NAME
                + ". filtroNombre: " + _filtroBusqueda.getNombre());
            listaObjetos = _auxnegocio.getAccesos(_filtroBusqueda.getNombre(), 0, 0, "acceso_label");
