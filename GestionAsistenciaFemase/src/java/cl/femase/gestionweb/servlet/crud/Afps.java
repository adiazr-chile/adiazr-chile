...
public class Afps extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final String CRUD_TABLE_NAME     = "Afps";
    private static final String CRUD_SERVLET_NAME   = "[AFPs.servlet]";
    private static final String FORWARD_PAGE        = "cruds/afps.jsp";
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        AfpBp claseBp = new AfpBp(appProperties);
    ...
    */
    private void forwardToCRUDPage(HttpServletRequest _request, 
        ...
        try {
            List<AfpVO> listaObjetos = new ArrayList<>();
            System.out.println(WEB_NAME + CRUD_SERVLET_NAME + "CRUD - " + CRUD_TABLE_NAME
                + ". filtroNombre: " + _filtroBusqueda.getNombre()
                + ". filtroEstado: " + _filtroBusqueda.getEstado());
            listaObjetos = _auxnegocio.getAfps(_filtroBusqueda.getNombre(),
                _filtroBusqueda.getEstado(), 0, 0, "afp_name");
