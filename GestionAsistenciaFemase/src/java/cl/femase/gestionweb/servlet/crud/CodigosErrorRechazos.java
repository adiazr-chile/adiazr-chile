...
public class CodigosErrorRechazos extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final String CRUD_TABLE_NAME     = "CodigosErrorRechazos";
    private static final String CRUD_SERVLET_NAME   = "[CodigosErrorRechazos.servlet]";
    private static final String FORWARD_PAGE        = "cruds/codigos_error_rechazos.jsp";
        
    public CodigosErrorRechazos() {
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        CodigoErrorRechazoBp claseBp = new CodigoErrorRechazoBp(appProperties);
        ...
        if(request.getParameter("action") != null){
            ...
            System.out.println(WEB_NAME + CRUD_SERVLET_NAME
                + "param busqueda Descripcion: " + request.getParameter("filtroDescripcion"));
            if (request.getParameter("filtroDescripcion") != null) 
                filtroDescripcion = request.getParameter("filtroDescripcion");
            
            FiltroBusquedaCRUDVO filtroVO = new FiltroBusquedaCRUDVO();
            filtroVO.setDescripcion(filtroDescripcion);
            ...
            CodigoErrorRechazoVO registro = new CodigoErrorRechazoVO();
            if(request.getParameter("id") != null){
                registro.setCodigo(request.getParameter("id"));
            }
    ...
    */
    private void forwardToCRUDPage(HttpServletRequest _request, 
        ...
        CodigoErrorRechazoBp _auxnegocio,
        FiltroBusquedaCRUDVO _filtroBusqueda){
    
        try {
            List<CodigoErrorRechazoVO> listaObjetos = new ArrayList<>();
            System.out.println(WEB_NAME + CRUD_SERVLET_NAME + "CRUD - " + CRUD_TABLE_NAME
                + ". filtro: " + _filtroBusqueda.getDescripcion());
            listaObjetos = _auxnegocio.getCodigos(_filtroBusqueda.getNombre(), 0, 0, "descripcion");
