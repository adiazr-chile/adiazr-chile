...
public class EventosMantencionHistController extends BaseServlet {
    protected static Logger m_logger = Logger.getLogger("gestionweb");

    private static final long serialVersionUID = 1L;
    
    public EventosMantencionHistController() {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(request.getParameter("action") != null){
            System.out.println(WEB_NAME+"\n[EventosMantencionHistController]"
...
//            resultado.setType("TDV");
            ...
            System.out.println(WEB_NAME+"cl.femase.gestionweb.servlet."
                + "consultas.EventosMantencionHistController."
            ...
            if (action.compareTo("list")==0) {
                ...
                try{
                    ...
                    System.out.println(WEB_NAME+"[EventosMantencionHistController]"
                    ...
                    listaObjetos = auxnegocio.getEventosMantencionHist(username,
                        tipoEvento,
                        startDate,
                        endDate,
                        startPageIndex, 
                    ...
                    int objectsCount = auxnegocio.getEventosMantencionHistCount(username,
                        tipoEvento,
                        startDate,
                        endDate);
