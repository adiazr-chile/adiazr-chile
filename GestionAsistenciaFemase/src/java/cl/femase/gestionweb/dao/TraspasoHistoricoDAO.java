    ...
    public ResultCRUDVO insertDetalleAsistenciaHistoricos(String _empresaId, 
        ...
        try{
            String sql = "insert into detalle_asistencia_historica ("
                    + "empresa_id ,  depto_id ,  cenco_id ,  rut_empleado,  "
                    + "fecha_hora_calculo,"
                    + "  fecha_marca_entrada,  hora_entrada ,  hora_salida ,  "
                    + "horas_teoricas ,"
                    + "  horas_trabajadas ,  minutos_extras_50 ,  "
                    + "hora_inicio_ausencia ,"
                    + "  hora_fin_ausencia ,  minutos_trabajados ,  "
                    + "horas_extras ,  holgura_minutos ,"
                    + "  es_feriado ,  minutos_extras_100 ,  "
                    + "hora_entrada_teorica ,  hora_salida_teorica ,"
                    + "  minutos_extras ,  art22 ,  minutos_atraso ,  "
                    + "minutos_no_trabajados_entrada ,"
                    + "  minutos_no_trabajados_salida ,  "
                    + "autoriza_mins_no_trab_entrada ,  "
                    + "autoriza_mins_no_trab_salida,"
                    + "  hrs_presenciales,  hrs_trabajadas,  "
                    + "observacion,  hrs_ausencia,  fecha_marca_salida,"
                    + "  hhmm_extras,  hhmm_atraso,  autoriza_atraso,  "
                    + "autoriza_hrsextras,  hhmm_justificadas,"
                    + "  hhmm_extras_autorizadas,  marca_entrada_comentario,  "
                    + "marca_salida_comentario,  "
                    + "hhmm_salida_anticipada, hrs_no_trabajadas, fecha_hora_traspaso) "
                + "select "
