...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="2">
    <tr class="table_column_header">
      ...
      <td width="14%">Horas trabajadas</td>
    </tr>
    	
        <#list details as detail>
            <tr class="table_row">
					<td class="table_column_data" >${detail.fecha}&nbsp;</td>
					<td align="center" class="table_column_data">${detail.labelTurno}&nbsp;</td>
					<td align="center" class="table_column_data">${detail.horasTrabajadas}</td>
				</tr>
