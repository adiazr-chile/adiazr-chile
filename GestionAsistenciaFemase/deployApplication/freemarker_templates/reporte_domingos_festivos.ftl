...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="2">
    <tr class="table_column_header">
      ...
      <td width="14%">Hora entrada</td>
      <td width="14%">Hora salida</td>
    </tr>
    	
        <#list details as detail>
            <tr class="table_row">
					<td class="table_column_data" >${detail.fecha}&nbsp;</td>
					<td align="center" class="table_column_data">${detail.horaEntrada}&nbsp;</td>
					<td align="center" class="table_column_data">${detail.horaSalida}</td>
					<td align="center" class="table_column_data">${detail.observacion}&nbsp;</td>
				</tr>
